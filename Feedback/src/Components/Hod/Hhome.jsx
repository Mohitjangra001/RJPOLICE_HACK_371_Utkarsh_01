...
const Hhome = () => {
    ...
    const fdata = async () => {
        ...
        const response = await axios.get(`http://localhost:3000/api/v2/countsA/`) //JUGAR
        console.log(response)
        setfbacks(response.data)
    }
    // //localhost:3000/api/v2/countsA/64dbc5db25871abf6b82b2e4`
                    ...
                    <div className={`h-[18vh] w-[90%] sm:w-[80%]  rounded-2xl shadow-md ${theme == "light" ? " bg-[#f5f1f0] shadow-lg" : "bg-[#0c131d] shadow-xl text-white"}`}>
                        <section className='flex justify-between px-5'>
                            <section className='py-5'>
                                ...
                                <h1 className={`font-bold text-xl ${theme == "light" ? "text-black" : "text-white"}`}>User Enrolled</h1>
                    ...
                    <div className={`h-[18vh] w-[90%] sm:w-[80%]   rounded-2xl shadow-md ${theme == "light" ? " bg-[#f5f1f0] shadow-lg" : "bg-[#0c131d] shadow-xl text-white"}`}>
                        <section className='flex justify-between px-5'>
                            <section className='py-5'>
                                ...
                                <h1 className={`font-bold text-xl ${theme == "light" ? "text-black" : "text-white"}`}>Police</h1>
                    ...
                    <div className='w-[100%] my-5  sm:my-0 sm:w-[30%] ' >
                        <div className={`h-[50vh]  w-[55vh]  rounded-2xl ${theme == "light" ? " bg-[#f5f1f0] shadow-lg" : "bg-[#0c131d] shadow-xl text-white"} `} >
                            <section className='flex px-7'>
                                ...
                                <select placeholder='Select District' onChange={(e) => setpsem(e.target.value)} className={`px-5 my-5 rounded-2xl text-left mx-5 '  ${theme == "light" ? " bg-[#f5f1f0]" : "bg-[#0c131d] border-[1px]  text-white"}`}>
                                    <option>sems</option>
                                    {sems.map((y) => (
