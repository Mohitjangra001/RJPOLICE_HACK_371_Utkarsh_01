                    ...
                    <div className={` border-r-[0.1px]  ${theme == "light" ? " bg-[#1e293b]" : "bg-[#1d232a]"} hidden md:block h-screen w-[100%] sm:w-[20%]  text-xl pl-2 pt-4`} >
                        ...
                        <div className='flex justify-start w-[30%]   mt-8 '>
                            <ul className='mt-4  cursor-pointer px-8 ' >
                                ...
                                <Link to='/hod/sems'>
                                    <li className={`text-white   my-4 w-[180px]  hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px]  px-3   rounded-md cursor-pointer  ${isActive("/hod/sems")}`}><VscFeedback size={35} className=' pr-2 pb-2 ' />Stations</li>
                                </Link>

                                <Link to='/hod/teacher'>
                                    <li className={`text-white my-4    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px] px-3 w-[180px]  rounded-md  cursor-pointer  ${isActive("/hod/teacher")}`}><MdManageAccounts size={35} className=' pr-2 pb-2 ' />Officers</li>
                                </Link>

                                <Link to='/hod/students'>
                                    <li className={`text-white w-[180px] my-4 px-3    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px] rounded-md  cursor-pointer  ${isActive("/hod/students")}}`}><PiStudent size={35} className=' pr-2 pb-2 ' />Public</li>
                                </Link>

                                <Link to='/hod/sub'>
                                    <li className={`text-white w-[180px] my-4 px-3    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px]  rounded-md  cursor-pointer  ${isActive("/hod/sub")}}`}><MdSubject size={35} className=' pr-2 pb-2 ' />Officer Assign</li>
                                </Link>

                                <Link to='/hod/efb'>
                                    <li className={`text-white my-4    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px] px-3 w-[180px]  rounded-md  cursor-pointer  ${isActive("/hod/efb")}`}><BiLastPage size={35} className=' pr-2 pb-2 ' />End-Station Feedback</li>
                                </Link>
                    ...
                    >
                        ...
                        <div className='flex flex-col text-xl  list-none'>
                            <ul className='mt-4  cursor-none' >
                                ...
                                <Link to='/hod/students'>
                                    <li className={`text-white w-[180px] my-4 px-3    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px] rounded-md  cursor-pointer  ${isActive("/hod/students")}}`}><PiStudent size={35} className=' pr-2 pb-2 ' />User</li>
                                </Link>

                                <Link to='/hod/sub'>
                                    <li className={`text-white w-[180px] my-4 px-3    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px]  rounded-md  cursor-pointer  ${isActive("/hod/sub")}}`}><MdSubject size={35} className=' pr-2 pb-2 ' />Service</li>
                                </Link>

                                <Link to='/hod/efb'>
                                    <li className={`text-white my-4    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px] px-3 w-[180px]  rounded-md  cursor-pointer  ${isActive("/hod/efb")}`}><BiLastPage size={35} className=' pr-2 pb-2 ' />Feedback</li>
                                </Link>
                                < section className='mt-4  px-8 sm:hidden' >
                                    {theme == "light" ? <section className=' flex items-center' onClick={handletheme} size={30}>
                                        <h1 className=' text-black font-semibold'></h1> <MdDarkMode size={30} className=' text-white' />
                    ...
                    <div className="w-full sm:w-[100%] h-[100%] bg-[#f1f5f9]">
                        <div className={`${theme === 'light' ? 'bg-white' : 'bg-[#1d232a]'} w-[100%] flex justify-between border-b-2 shadow-lg ml-0 h-[9vh] `}>
                            ...
                            <section className="flex justify-center items-center ">
                                <h1 className={`text-center font-bold text-xl px-5 ${theme == "light" ? "text-black" : "text-white"}`}>Manager Dashboard</h1>
                            </section>
