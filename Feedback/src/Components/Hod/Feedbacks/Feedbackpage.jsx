...
const Feedbackpage = () => {
    ...
    const feedbacks = async () => {
        ...
        try {
            setloader(true)
            // http://localhost:3000/api/v2/feedback/${id.id}
            ...
            if (data.feedback[0].sem.enabled) {
                setenable("Station Enabled For Feedback")

            } else {
                setenable("Station disabled For Feedback")
            }
            setcdata(exportdata)
            setfback(data.feedback)
    ...
    const getbysub = async (subject) => {
        ...
        // http://localhost:3000/api/v2/feedbacksub
                    ...
                    <table className='border-collapse w-[100%] '>
                        <thead>
                            <tr className=' bg-blue-600 '>
                                ...
                                <th className='p-2 text-left py-2 text-white text-lg'>Users</th>
                            ...
                            {ploader ?
                                ...
                                : <>
                                    ...
                                    <div className={`${theme == "dark" ? " focus:outline-none border-none text-white " : ""}`}>
                                        ...
                                        <hr></hr>
                                        <h1 className='font-bold  text-1xl'>Station No.</h1>
