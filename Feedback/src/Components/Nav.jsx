            ...
            <div className='flex justify-between items-center px-4 py-4 shadow-lg'>
                <section>
                    <h1 className='mx-2 font-bold text-md sm:text-2xl text-blue-700 cursor-pointer flex'>
                        <MdLocalPolice size={23} className='mr-2 sm:mt-2 mt-1' />
                        Rajasthan<span className='text-gray-500'>-Police</span>
                    </h1>
                </section>
                ...
                <ul className='hidden md:flex items-center cursor-pointer'>
                    ...
                    <li className='mx-3 font-bold text-lg hover:border-b-2 border-blue-700 '>Community</li>
                        ...
                        <>
                            {auth?.user?.role === 1 ? (
                                <div className='flex flex-row cursor-pointer' onClick={() => navigate('/hod')} >
                                    <li className='mx-2 font-bold text-lg hover:border-b-2 border-blue-700 mt-[7px] items-center' >Manager</li>
                                    <li className=' ml-0' >
                                ...
                                <>
                                    {auth.user?.role === 2 ? (
                                        <div className='flex flex-row cursor-pointer' onClick={() => navigate('/Admin')} >
                                            <li className='mx-2 font-bold text-lg hover:border-b-2 border-blue-700  mt-2 items-center' >Admin</li>
                                            <li className=' ml-0' >
                                                <BiUserCircle size={40} className='text-blue-700' />
                                            </li>
                                        </div>
                ...
                <ul className={`bg-gray-300 flex flex-col absolute left-0 h-screen shadow-sm ${nav ? 'w-[90%] sm:w-17' : "w-0 overflow-hidden"} transition-all ease-linear duration-200`}>
                    ...
                    {!auth?.user ? (
                        ...
                        <>
                            {auth?.user?.role === 1 ? (
                                <div className='flex flex-row cursor-pointer' onClick={() => navigate('/hod')} >
                                    <li className='mx-2 font-bold mt-2 text-black items-center' >Manager</li>
                                    <li className=' ml-0' >
                                ...
                                <>
                                    {auth.user?.role === 2 ? (
                                        <div className='flex flex-row cursor-pointer' onClick={() => navigate('/Admin')} >
                                            <li className='mx-2 font-bold mt-2 items-center text-black' >Admin</li>
                                            <li className=' ml-0' >
                                                <BiUserCircle size={40} className='text-green-700' />
                                            </li>
                                        </div>
                                        ...
                                        <>
                                            <section className='flex h-[30vh] font-bold'>
                                                <li className="cursor-pointer flex group-hover:underline-offset-1">
                                                    <Link className='mx-2 mt-2 text-black hover:border-b-2 border-blue-700' to='/cof'>Stations Feedback</Link>
                                                </li>
                                                <li className="cursor-pointer flex group-hover:underline-offset-1">
