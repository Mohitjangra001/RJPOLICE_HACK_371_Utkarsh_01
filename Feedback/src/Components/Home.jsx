            ...
            <div className={`${theme == "light" ? "bg-white" : "bg-[#1d232a]"} flex flex-col sm:flex-row h-screen `}>
                <div className='h-[50vh] w-full sm:h-[81vh] sm:w-[43%] flex flex-col  justify-center  items-start p-5 '>
                    ...
                    <p className={`${theme == "light" ? "" : "text-white"} md:ml-[8vh]`}>
                        <h1 className={`font-bold  text-4xl mt-2 sm:text-5xl px-2`}> Rajasthan Police | Feedback </h1>
                        <h1 className='font-bold w-[100%] sm:w-[100%] mt-4 p-2 sm:text-xl'>Your Voice Matters! This platform bridges the gap between Public and Police, allowing seamless feedback submission and in-depth analysis. Join us in shaping a better  experience!</h1>
                        <TypeAnimation
                            sequence={[
