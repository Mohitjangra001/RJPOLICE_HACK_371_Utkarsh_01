    ...
    <div className='flex h-screen'>
      ...
      <div className='flex flex-col w-[100%] sm:w-1/2 justify-center items-center'>
        ...
        <form className='w-full px-6 md:px-[20vh]' onSubmit={handlesubmit}>
          ...
          <h1 className='text-center text-2xl font-bold text-blue-700'>Sign Up</h1>
          ...
          <input type='text' required placeholder='Enter Aadhar Number' className='w-full p-2 border-2 rounded-2xl my-2 '
          ...
          <Select className='w-full ant-input text-xl mt-4 rounded-2xl ' placeholder='Select District' onChange={handlechange}>
            {departments.map((s) => (
          ...
          <Select required className='w-full ant-input text-xl mt-4 rounded-2xl ' placeholder='Select a Block ' onChange={handlesem}>
            {semester.map((s) => (
              <Option key={s._id} value={s._id}>
                {s.name}
              </Option>
          ...
          <Select required className='w-full ant-input text-xl mt-4 rounded-2xl ' placeholder='Select a Ward' onChange={handles}>
            {sshift.map((s) => (
              <Option key={s._id} value={s._id}>
                {s.name}
              </Option>
