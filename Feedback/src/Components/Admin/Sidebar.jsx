                    ...
                    <div className={` border-r-[0.5px] ${theme == "light" ? " bg-[#1d232a]" : "bg-[#1d232a]"} hidden md:block h-screen w-[100%] sm:w-[20%]  text-xl pl-2 pt-4`} >
                        ...
                        <div className='flex justify-start w-[50%]   mt-8 '>
                            <ul className='mt-4  cursor-pointer px-8 ' >
                                ...
                                <Link to='/admin/cform'>
                                    <li className={`text-white w-[180px]  my-4    hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex px-3 text-[16px]   rounded-md  cursor-pointer'  ${isActive("/admin/cform")}`}><FaWpforms size={35} className=' pr-2 pb-2 ' />Station Form</li>
                                </Link>

                                <Link to='/admin/ecf'>
                                    <li className={`text-white   my-4 w-[180px]  hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px]  px-3   rounded-md cursor-pointer  ${isActive("/admin/ecf")}`}><VscFeedback size={35} className=' pr-2 pb-2 ' />District-Form</li>
                                </Link>
                    ...
                    >
                        ...
                        <div className='flex flex-col text-xl  list-none'>
                            <ul className='mt-4  cursor-none' >
                                ...
                                <Link to='/admin/ecf'>
                                    <li className={`text-white   my-4 w-[180px]  hover:rounded-md  font-semibold  hover:bg-[#6528F7]  flex  text-[16px]  px-3   rounded-md cursor-pointer  ${isActive("/admin/ecf")}`}><VscFeedback size={35} className=' pr-2 pb-2 ' />Form-Questions</li>
                                </Link>
                    ...
                    <div className=" h-[50vh] w-[100%] bg-[#f1f5f9]">
                        <div className={`${theme === 'light' ? 'bg-white' : 'bg-[#1d232a]'} w-[100%] flex justify-between border-b-2 shadow-lg ml-0 h-[9vh] `}>
                            ...
                            <section className="flex justify-center items-center ">
                                <h1 className={`text-center font-bold text-xl px-5 ${theme == "light" ? "text-black" : "text-white"}`}>ADMIN DASHBOARD</h1>
                            </section>
                            <section>
