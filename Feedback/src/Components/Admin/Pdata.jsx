                    ...
                    <div className={`h-[18vh] w-[90%] sm:w-[80%]  rounded-2xl shadow-md ${theme == "light" ? " bg-[#f5f1f0] shadow-lg" : "bg-[#0c131d] shadow-xl text-white"}`}>
                        <section className='flex justify-between px-5'>
                            <section className='py-5'>
                                ...
                                <h1 className={`font-bold text-xl ${theme == "light" ? "text-black" : "text-white"}`}>Users Registered</h1>
                    ...
                    <div className={`h-[18vh] w-[90%] sm:w-[80%]   rounded-2xl shadow-md ${theme == "light" ? " bg-[#f5f1f0] shadow-lg" : "bg-[#0c131d] shadow-xl text-white"}`}>
                        <section className='flex justify-between px-5'>
                            <section className='py-5'>
                                ...
                                <h1 className={`font-bold text-xl ${theme == "light" ? "text-black" : "text-white"}`}>Officer</h1>
